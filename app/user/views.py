...
from .serializers import (
    ...
    AuthTokenSerializer,CreatePasswordFromChangedOTPSerializer,
    EmailSerializer,InitiatePasswordResetSerializer,ListUserSerializer,
    BasicUserInfoSerializer,AccountVerificationSerializer,
)
        ...
        responses={
            200: inline_serializer(
                ...
                fields={
                    ...
                    "message": serializers.CharField(default="Successful Verified Account")
                }
            )
        }
    )
